...
export default function HowItWorksSection() {
     ...
     return (
          <section id="how-it-works" className="py-16 bg-gradient-to-br from-gray-50 to-indigo-50 dark:from-gray-900 dark:to-indigo-900/20">
               <div className="container mx-auto px-4">
                    ...
                    >
                         ...
                         >
                              <h2 className="text-4xl font-bold text-gray-800 dark:text-white mb-4 relative">
                                   How It Works
                                   <motion.div 
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                         {steps.map((step, index) => (
                              ...
                              >
                                   ...
                                   <motion.div
                                        className="relative h-full bg-white dark:bg-gray-800/70 backdrop-blur-sm rounded-2xl p-6 border border-gray-100 dark:border-gray-700 overflow-hidden"
                                        whileHover={{ 
                                   ...
                                   >
                                        ...
                                        <div className="flex flex-col items-center pt-2">
                                             ...
                                             >
                                                  ...
                                                  />
                                                  <motion.span 
                                                       className="text-2xl font-bold text-indigo-600 dark:text-indigo-300 z-10"
