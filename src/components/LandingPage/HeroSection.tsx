               ...
               <div className="container mx-auto px-4">
                    <div className="flex flex-col md:flex-row items-center">
                         <div className="md:w-1/2 mb-10 md:mb-0">
                              ...
                              >
                                   <button className="bg-white text-indigo-600 px-6 py-3 rounded-lg font-medium hover:bg-gray-100 transition-colors active:scale-[0.98]">
                                        Get Started
                                   </button>
                                   <button className="bg-transparent border-2 border-white px-6 py-3 rounded-lg font-medium hover:bg-white/10 transition-colors active:scale-[0.98]">
                                        Watch Demo
                                   </button>
                              </motion.div>
                         </div>
                         ...
                         >
                              <div className="bg-white/10 backdrop-blur rounded-2xl p-6 max-w-md mx-auto shadow-xl">
                                   <div className="flex justify-between items-center mb-4">
                                        ...
                                        <button className="bg-white/20 p-2 rounded-lg hover:bg-white/30 transition-colors active:scale-95">
                                             <Plus size={16} />
                                        </button>
                                   </div>
                                   ...
                                   <div className="space-y-4">
                                        {notes.slice(0, 3).map(note => (
                                             <motion.div 
                                                  key={note.id} 
                                                  className="bg-white/10 p-4 rounded-xl backdrop-blur hover:bg-white/20 transition-colors cursor-pointer"
                                                  whileHover={{ y: -5 }}
                                             >
