...
export default function TestimonialsSection() {
     ...
     return (
          <section id="testimonials" className="py-20 bg-gradient-to-br from-indigo-50 to-violet-50 dark:from-gray-800 dark:to-gray-900">
               <div className="container mx-auto px-4">
                    ...
                    >
                         <motion.div 
                              className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-indigo-100 dark:bg-gray-700 mb-6"
                              initial={{ scale: 0 }}
                         ...
                         <h2 className="text-4xl font-bold dark:text-white mb-4 bg-gradient-to-r from-indigo-600 to-violet-600 bg-clip-text text-transparent">
                              What Our Users Say
                         </h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                         {testimonials.map((testimonial, index) => (
                              <motion.div
                                   ...
                                   whileTap={{ scale: 0.98 }}
                              >
                                   <div className="absolute top-6 left-8 text-indigo-100 dark:text-indigo-900/50 group-hover:text-indigo-200 dark:group-hover:text-indigo-800/70 transition-colors">
                                        <Quote size={48} />
                                   </div>
                                   ...
                                   <p className="text-gray-700 dark:text-gray-200 text-lg mb-6 pl-8 relative z-10">
                                        {testimonial.quote}
                                   </p>
                                        ...
                                        <div className="relative">
                                             <div className="bg-gradient-to-br from-indigo-500 to-violet-600 p-0.5 rounded-full">
                                                  <div className="bg-white dark:bg-gray-800 rounded-full p-1">
                                                       <div className="bg-gray-200 dark:bg-gray-700 w-14 h-14 rounded-full flex items-center justify-center">
