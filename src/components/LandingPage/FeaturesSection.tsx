...
export default function FeaturesSection() {
     ...
     return (
          <section id="features" className="py-20 bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-950 transition-colors duration-300">
               <div className="container mx-auto px-4 max-w-6xl">
                    ...
                    >
                         <motion.h2
                              className="text-4xl font-bold text-gray-900 dark:text-white mb-4 bg-clip-text transition-colors duration-300"
                              initial={{ opacity: 0 }}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                         {features.map((feature, index) => (
                              ...
                              >
                                   ...
                                   <h3 className="text-xl font-bold mb-3 dark:text-white text-gray-800 group-hover:text-indigo-600 dark:group-hover:text-indigo-300 transition-colors duration-300">{feature.title}</h3>
